...
def plotar_regiao_viavel(result):
    ...
    # Restrições
    plt.plot(x_vals, x_vals + 1, "blue", label=r"$-x_1 + x_2 \leq 1$")
    plt.axvline(3, color="orange", label=r"$x_1 \leq 3$")
    plt.axhline(2, color="purple", label=r"$x_2 \leq 2$")
...
def main():
    ...
    print(pl.HiGHS_CMD().available())

    problem_name = "Problema_A"
